...
import ImageHeroes from '../../images/heroes-img.png'
            ...
            <div class="container container-heroes">
                <div class="row row-heroes">
                    <div class="col-6 heroes-copy">
                        <h6 class="text-title__motto">Cerdas - Kreatif - Inovatif</h6>
                        <h1 class="text-title__heading">Sekolah swasta dengan akreditasi A di Jakarta</h1>
                        <p class="text-title__description">SMK Insan Mandiri Jakarta menyediakan berbagai fasilitas penunjang pendidikan bagi anak didiknya. Terdapat guru-guru dengan kualitas terbaik yang kompeten dibidangnya, kegiatan penunjang pembelajaran seperti ekstrakurikuler (eskul), organisasi siswa, komunitas belajar, tim olangraga, dan perpustakaan sehingga siswa dapat belajar secara maksimal.</p>
